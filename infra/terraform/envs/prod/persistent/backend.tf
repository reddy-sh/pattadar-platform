...
#   1. aws s3 mb s3://pattadar-terraform-state-222634365368 --region ap-south-1
#   2. aws s3api put-bucket-versioning --bucket pattadar-terraform-state-222634365368 \
#        --versioning-configuration Status=Enabled
#   3. aws s3api put-public-access-block --bucket pattadar-terraform-state-222634365368 \
