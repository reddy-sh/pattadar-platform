# Root-level re-exports — the runtime layer reads these via
# terraform_remote_state (key prod/persistent.tfstate), and the founder reads
# route53_name_servers for the registrar NS switch (Track B).
...
# The 4 values the founder sets at the registrar to cut pattadar.com over
# from Azure DNS: `terraform output route53_name_servers`
