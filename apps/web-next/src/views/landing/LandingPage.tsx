 ...
 *
 * Ported as-is from apps/web/src/pages/landing/LandingPage.tsx (founder
 * decision D4 — kept exactly as designed, not restyled onto Minimals).
 */
...
export function LandingPage() {
  ...
  const startSignIn = () => {
    router.push(isAuthMocked || isAuthenticated ? '/app' : '/login');
  };
        ...
        <Container maxWidth="lg" sx={{ py: 3 }}>
          <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: 2 }}>
            ...
            <Box sx={{ display: 'flex', gap: 3 }}>
              <Link component={RouterLink} href="/privacy" variant="caption" sx={{ color: INK_FAINT }}>
                Privacy
              </Link>
              <Link component={RouterLink} href="/terms" variant="caption" sx={{ color: INK_FAINT }}>
                Terms
              </Link>
