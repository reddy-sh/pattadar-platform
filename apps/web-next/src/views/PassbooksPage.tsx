...
export function PassbooksPage() {
  ...
  const openParcels = (b: Passbook) => router.push(`/app/parcels?pb=${b.id}`);
  ...
  const rowActions = (b: Passbook) => [
    ...
    { key: 'record', label: 'Passbook record', onClick: () => router.push(`/app/passbooks/${b.id}`) },
                      ...
                      <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.75, mt: 0.25 }}>
                        ...
                        {gname && (
                          <Chip
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              router.push(`/app/parcels?group=${b.groupId}`);
                            }}
                          />
                        )}
